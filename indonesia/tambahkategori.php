...
<head>
    ...
    <title>Tambah Kategori | Wisata Yuk</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form method="POST" action="tkategori.php">
                     <div class="row mb-3">
                      <label for="inputid" class="col-sm-2 col-form-label">Id Kategori</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputid" name="id_kategori">
                      </div>
                    </div>
                    <div class="row mb-3">
